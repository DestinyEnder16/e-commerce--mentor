...
function NavBar({ totalItem, setTotalItem }) {
  ...
  return (
    <>
      <nav className="w-full flex flex-row justify-between py-5 px-8 shadow-lg sticky top-0 z-40 bg-[#fff] relative lg:px-[9rem] lg:py-10 lg:shadow">
        <div className="flex items-baseline ">
          ...
          <span className="text-[3rem] font-bold text-[#1D2025] xl:text-[3.5rem]">
            sneakers
          </span>

          <ul className="lg:flex hidden w-full ml-12 gap-10 text-[1.5rem] xl:text-[2rem] text-[hsl(220,14%,75%)]">
            <li>
        ...
        <div className="flex items-center">
          <span
            className="mr-6 relative cursor-pointer xl:mr-[4rem]"
          ...
          <span>
            <img
              src="https://i.postimg.cc/yWP3yR8Y/image-avatar.png"
              alt="User profile"
              className="size-[25px] xl:size-[40px]"
            />
          </span>
        </div>
